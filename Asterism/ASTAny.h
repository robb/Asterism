...
ASTERISM_USE_INSTEAD(ASTAny) BOOL __ASTAny_NSDictionary(NSDictionary *dict, NS_NOESCAPE BOOL(^block)(id obj));
ASTERISM_USE_INSTEAD(ASTAny) BOOL __ASTAny_NSFastEnumeration(id<NSFastEnumeration> collection, NS_NOESCAPE BOOL(^block)(id obj));
...
ASTERISM_OVERLOADABLE BOOL ASTAny(NSDictionary *dict, NS_NOESCAPE BOOL(^block)(id obj)) {
...
///          @c block.
ASTERISM_OVERLOADABLE BOOL ASTAny(id<NSFastEnumeration> collection, NS_NOESCAPE BOOL(^block)(id obj)) {
