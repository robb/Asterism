...
ASTERISM_USE_INSTEAD(ASTAll) BOOL __ASTAll_NSDictionary(NSDictionary *dict, NS_NOESCAPE BOOL(^block)(id obj));
ASTERISM_USE_INSTEAD(ASTAll) BOOL __ASTAll_NSFastEnumeration(id<NSFastEnumeration> collection, NS_NOESCAPE BOOL(^block)(id obj));
...
ASTERISM_OVERLOADABLE BOOL ASTAll(NSDictionary *dict, NS_NOESCAPE BOOL(^block)(id obj)) {
...
ASTERISM_OVERLOADABLE BOOL ASTAll(id<NSFastEnumeration> collection, NS_NOESCAPE BOOL(^block)(id obj)) {
