...
ASTERISM_USE_INSTEAD(ASTGroupBy) NSDictionary *__ASTGroupBy_NSDictionary_block(NSDictionary *dict, NS_NOESCAPE id<NSCopying> (^block)(id obj));
ASTERISM_USE_INSTEAD(ASTGroupBy) NSDictionary *__ASTGroupBy_NSDictionary_keyPath(NSDictionary *dict, NSString *keyPath);
ASTERISM_USE_INSTEAD(ASTGroupBy) NSDictionary *__ASTGroupBy_NSFastEnumeration_block(id<NSFastEnumeration> collection, NS_NOESCAPE id<NSCopying> (^block)(id obj));
...
ASTERISM_OVERLOADABLE NSDictionary *ASTGroupBy(NSDictionary *dict, NS_NOESCAPE id<NSCopying> (^block)(id obj)) {
...
/// grouped[@"odd"];  /// { @1, @3, @5 }
/// @endcode
ASTERISM_OVERLOADABLE NSDictionary *ASTGroupBy(id<NSFastEnumeration> collection, NS_NOESCAPE id<NSCopying> (^block)(id obj)) {
